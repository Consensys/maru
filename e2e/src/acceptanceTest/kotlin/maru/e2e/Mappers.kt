...
// TODO: This is a copypaste from https://github.com/Consensys/linea-monorepo/blob/main/jvm-libs/linea/web3j-extensions/src/main/kotlin/net/consensys/linea/web3j/DomainObjectMappers.kt clean up later
object Mappers {
    ...
    fun executionPayloadV3FromBlock(block: EthBlock.Block): ExecutionPayloadV3 {
        ...
        val transactions = block.transactions.map {
        ...
        return ExecutionPayloadV3(
            parentHash, feeRecipient, stateRoot, receiptsRoot, logsBloom, prevRandao, blockNumber,
            gasLimit, gasUsed, timestamp, extraData, baseFeePerGas, blockHash, transactions,
    ...
    fun executionPayloadV1FromBlock(block: EthBlock.Block): ExecutionPayloadV1 {
        ...
        val gasUsed = UInt64.valueOf(block.gasUsed)
        val timestamp = UInt64.valueOf(block.timestamp)
//        val extraData = Bytes.fromHexString(block.extraData.substring(0, ExtraDataStringHexLength))
        val extraData = Bytes.fromHexString(block.extraData)
        val baseFeePerGas = UInt256.valueOf(block.baseFeePerGas)
        val blockHash = Bytes32.fromHexString(block.hash)
